        ...
        return (
            <>
                ...
                <div className="page-content">
                    <Banner title="3D STEP & RISER" pagename="3D STEP & RISER" description="The essence of interior design will always be about people and how they live. It is about the realities of what makes for an attractive, civilized." bgimage={bnrimg}/>
                    <WhatWeDo6 />
                    <Services6 />
                    <Services7 />

                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-6 col-xs-100pc m-b30">
                                    <div className="sx-box sx-product-box   overflow-hide">
                                        ...
                                        <div className="sx-info p-t20 text-center">
                                            ...
                                            <NavLink to={"/packing-detail"}>Happy Ninja</NavLink>
                                            </h5>
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-6 col-xs-100pc m-b30">
                                    <div className="sx-box sx-product-box   overflow-hide">
                                        ...
                                        <div className="sx-info p-t20 text-center">
                                            <h5 className="sx-title">
                                                <NavLink to={"/packing-detail"}>Flying Ninja</NavLink>
                                            </h5>
                                            <span className="price">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-6 col-xs-100pc m-b30">
                                    <div className="sx-box sx-product-box   overflow-hide">
                                        ...
                                        <div className="sx-info p-t20 text-center">
                                            <h5 className="sx-title">
                                                <NavLink to={"/packing-detail"}>Half White</NavLink>
                                            </h5>
                                            <span className="price">
                                                <ins>
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-6 col-xs-100pc m-b30">
                                    <div className="sx-box sx-product-box   overflow-hide">
                                        ...
                                        <div className="sx-info p-t20 text-center">
                                            <h5 className="sx-title">
                                                <NavLink to={"/packing-detail"}>Woo Ninja</NavLink>
                                            </h5>
                                            <span className="price">
                                                <ins>

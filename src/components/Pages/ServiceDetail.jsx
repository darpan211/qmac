    ...
    render() {
        return (
            <>
                ...
                <Banner title="GVT STEP & RISER" pagename="GVT STEP & RISER" description="The essence of interior design will always be about people and how they live. It is about the realities of what makes for an attractive, civilized." bgimage={bnrimg}/>
                                    ...
                                    <div className="about4-section m-b20 bg-gray p-a20">
                                        <div className="widget widget_services">
                                            ...
                                            <ul className="bg-white">
                                                <li><NavLink to={"/4-feet-3d-step-riser"}>Architecture</NavLink></li>
                                                <li><NavLink to={"/4-feet-3d-step-riser"}>Interior</NavLink></li>
                                                <li><NavLink to={"/4-feet-3d-step-riser"}>Decoration</NavLink></li>
                                                <li><NavLink to={"/4-feet-3d-step-riser"}>Furniture</NavLink></li>
                                                <li><NavLink to={"/4-feet-3d-step-riser"}>Floor Plan</NavLink></li>
                                                <li><NavLink to={"/4-feet-3d-step-riser"}>Exterior</NavLink></li>
                                            </ul>
                                        </div>
                                        <div className="wt-icon-box-wraper left bg-white p-a15 m-b10">
                                            <NavLink to={"/4-feet-3d-step-riser"} className="btn-block">
                                        ...
                                        <div className="about4-content m-t30">
                                            ...
                                            <NavLink to={"/4-feet-3d-step-riser"} className="site-button-link">Read More</NavLink>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-6 col-md-12">
                                                        <ul className="list-angle-right anchor-line">
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}>We provide high quality design services.</NavLink></li>
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}>We are confident about our projects.</NavLink></li>
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}>A good Work Environment For work</NavLink></li>
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}>Communication Skills to getting in touch</NavLink></li>
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}> Renovations Benefit of Service</NavLink></li>
                                                        </ul>
                                                    </div>
                                                    <div className="col-lg-6 col-md-12">
                                                        <ul className="list-angle-right anchor-line">
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}>Sustainability and modern tech.</NavLink></li>
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}>A Career Overview opportunity Available</NavLink></li>
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}>Scientific Skills For getting a better result</NavLink></li>
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}> Historic Renovations and Restorations.</NavLink></li>
                                                            <li><NavLink to={"/4-feet-3d-step-riser"}>Project on time and Latest Design</NavLink></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>

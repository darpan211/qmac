                                ...
                                <div className="col-xl-6 col-lg-6 col-md-12">
                                    <div className="about-home-3 m-b30 bg-white">
                                        ...
                                        <ul className="list-angle-right anchor-line">
                                            <li><NavLink to="/about-us">We provide a architectural 3D modeling services.</NavLink></li>
                                            <li><NavLink to="/about-us">Our specialists are ready to consult you on any topic.</NavLink></li>
                                            <li><NavLink to="/about-us">We develop and implement better interior design.</NavLink></li>
                                            <li><NavLink to="/about-us">We provide high-quality interior services for clients.</NavLink></li>
                                        </ul>
                                        <div className="text-left">
                                            <NavLink to="/about-us" className="site-button btn-half"><span>Read More</span></NavLink>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-12">

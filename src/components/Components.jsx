            ...
            <BrowserRouter basename="/">
                ...
                <div className="page-wraper">
                        <Routes>
                            ...
                            <Route path='/4-feet-3d-step-riser' element={<Services1/>} />
                            <Route path='/4-feet-full-body-step-riser' element={<Services2/>} />
                            <Route path='/4-feet-gvt-step-riser' element={<ServiceDetail/>} />

                            <Route path='/3-25-feet-full-body-step-riser' element={<Team1/>} />
                            <Route path='/3-feet-gvt-step-riser' element={<Team2/>} />
                            <Route path='/team-single' element={<TeamDetail/>} />

                            <Route path='/4-feet-double-charge-step-riser' element={<OurHistory/>} />
                            <Route path='/3-25-feet-gvt-step-riser' element={<FontIcons/>} />
                            ...
                            <Route path='/brochure' element={<BlogGrid/>} />
                            ...
                            <Route path='/packing-detail' element={<ShopList/>} />
